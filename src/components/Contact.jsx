...
const Contact = () => {
  return (
    <div className='contact-container mt-[-70px] w-[100%] flex items-center justify-center'>
        <div className="contact-block bg-black h-[600px] w-[40%] rounded-2xl flex flex-col items-center gap-10 justify-center">
            <h1 className='mt-6 text-5xl'>KONTAKT</h1>
            <p>Jeśli masz jakieś pytanie, pytaj śmiało</p>
            ...
            <span className='flex items-center gap-4 text-2xl'>
                <FontAwesomeIcon icon={faAt} className='text-4xl'/>

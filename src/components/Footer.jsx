...
const Footer = () => {
  ...
  return (
    <footer className='w-full h-[70px] bg-black flex items-center justify-between text-2xl'>
        <p className='ml-5'>Bartosz Miecznikowski 2025 &copy;</p>
        <span className='flex gap-5 mr-10 items-center'>
